...
function simulation(md,env,task)
    ...
    taskname={'glucose+coarse_grained' 'pairsOfConstraint' 'allLinearOFs' 'scatterPlot' 'biomass+X' 'biomass+ATP+X''biomass+minFlux+X'};    
...
%                 fprintf('model: %s, dataset: %s, metabolite: %d/%d\n',mdname{md},envname{gr},i,length(model.mets));
            ...
            mindist=pareto2(glob,amodel,@minRedox,md,task,bmMin,bmMax);
            solution=[solution;mindist];
            tit=[tit '+Min Rd'];

            mindist=pareto2(glob,amodel,@minATPProd,md,task,bmMin,bmMax);    
            solution=[solution;mindist];
            tit=[tit '+Min ATPprod'];

            mindist=pareto2(glob,amodel,@maxATPProd,md,task,bmMin,bmMax);    
            solution=[solution;mindist];
            tit=[tit '+Max ATPprod'];

            mindist=pareto2(glob,amodel,@minManhattan,md,task,bmMin,bmMax);    
            solution=[solution;mindist];
            tit=[tit '+Min Flux']; 
...
%                 fprintf('model: %s, dataset: %s, metabolite: %d/%d\n',mdname{md},envname{gr},i,length(model.mets));
            ...
            mindist=pareto3(glob,amodel,@minRedox,md,task,bmMin,bmMax,atpMin,atpMax);
            solution=[solution;mindist];
            tit=[tit '+Min Rd'];

            mindist=pareto3(glob,amodel,@minATPProd,md,task,bmMin,bmMax,atpMin,atpMax);    
            solution=[solution;mindist];
            tit=[tit '+Min ATPprod'];

            mindist=pareto3(glob,amodel,@maxATPProd,md,task,bmMin,bmMax,atpMin,atpMax);    
            solution=[solution;mindist];
            tit=[tit '+Max ATPprod'];

            mindist=pareto3(glob,amodel,@minManhattan,md,task,bmMin,bmMax,atpMin,atpMax);    
            solution=[solution;mindist];
            tit=[tit '+Min Flux']; 
